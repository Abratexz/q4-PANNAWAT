...
?>
	<tr>
		...
		<td>			
			...
			<a  class="btn btn-primary" href="#" onclick="update(<?=$item["pid"]?>)">แก้ไข</a>
			<a  class="btn btn-danger" href="?action=delete&pid=<?=$item["pid"]?>">ลบ</a>
		</td>
	</tr>
<?php } ?>
...
<a class="btn btn-primary"href="mpage.php">< เลือกสินค้าต่อ</a>
  </article>
